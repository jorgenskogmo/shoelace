...
// By default, this script will look for a script ending in klik.js and set the base path to the directory that
// contains that file. To override this behavior, you can add the data-klik attribute to any script on the page
// (it probably makes the most sense to attach it to the Klik script, but it could also be on a bundle). The value
