...
import '../../../dist/klik.js';
import type KlikSwitch from './switch';

describe('<klik-switch>', () => {
  it('should be disabled with the disabled attribute', async () => {
    const el = await fixture<KlikSwitch>(html` <klik-switch disabled></klik-switch> `);
  ...
  it('should be valid by default', async () => {
    const el = await fixture<KlikSwitch>(html` <klik-switch></klik-switch> `);
