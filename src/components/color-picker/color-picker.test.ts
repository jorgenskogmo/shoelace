...
import '../../../dist/klik.js';
import type KlikColorPicker from './color-picker';

describe('<klik-color-picker>', () => {
  it('should emit change and show correct color when the value changes', async () => {
    const el = await fixture<KlikColorPicker>(html` <klik-color-picker></klik-color-picker> `);
  ...
  it('should not render in a dropdown when inline is enabled', async () => {
    const el = await fixture<KlikColorPicker>(html` <klik-color-picker inline></klik-color-picker> `);
    const dropdown = el.shadowRoot.querySelector('klik-dropdown');
  ...
  it('should show opacity slider when opacity is enabled', async () => {
    const el = await fixture<KlikColorPicker>(html` <klik-color-picker opacity></klik-color-picker> `);
