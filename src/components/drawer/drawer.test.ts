...
import '../../../dist/klik.js';
import type KlikDrawer from './drawer';

describe('<klik-drawer>', () => {
  it('should be visible with the open attribute', async () => {
    const el = await fixture<KlikDrawer>(html`
  ...
  it('should not be visible without the open attribute', async () => {
    const el = await fixture<KlikDrawer>(
  ...
  it('should allow initial focus to be set', async () => {
    const el = await fixture<KlikDrawer>(html` <klik-drawer><input /></klik-drawer> `);
