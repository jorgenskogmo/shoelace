...
[component-header:klik-tab-group]
...
```html preview
<klik-tab-group placement="bottom">
  <klik-tab slot="nav" panel="general">General</klik-tab>
  <klik-tab slot="nav" panel="custom">Custom</klik-tab>
  <klik-tab slot="nav" panel="advanced">Advanced</klik-tab>
  <klik-tab slot="nav" panel="disabled" disabled>Disabled</klik-tab>
...
```html preview
<klik-tab-group placement="start">
  <klik-tab slot="nav" panel="general">General</klik-tab>
  <klik-tab slot="nav" panel="custom">Custom</klik-tab>
  <klik-tab slot="nav" panel="advanced">Advanced</klik-tab>
  <klik-tab slot="nav" panel="disabled" disabled>Disabled</klik-tab>
...
```html preview
<klik-tab-group class="tabs-closable">
  <klik-tab slot="nav" panel="general">General</klik-tab>
  <klik-tab slot="nav" panel="closable-1" closable>Closable 1</klik-tab>
  <klik-tab slot="nav" panel="closable-2" closable>Closable 2</klik-tab>
  <klik-tab slot="nav" panel="closable-3" closable>Closable 3</klik-tab>

  <klik-tab-panel name="general">This is the general tab panel.</klik-tab-panel>
  <klik-tab-panel name="closable-1">This is the first closable tab panel.</klik-tab-panel>
  <klik-tab-panel name="closable-2">This is the second closable tab panel.</klik-tab-panel>
  <klik-tab-panel name="closable-3">This is the third closable tab panel.</klik-tab-panel>
</klik-tab-group>

<script>
  const tabGroup = document.querySelector('.tabs-closable');

  tabGroup.addEventListener('klik-close', async event => {
    const tab = event.target;
    const panel = tabGroup.querySelector(`klik-tab-panel[name="${tab.panel}"]`);
...
```html preview
<klik-tab-group>
  <klik-tab slot="nav" panel="tab-1">Tab 1</klik-tab>
  <klik-tab slot="nav" panel="tab-2">Tab 2</klik-tab>
  <klik-tab slot="nav" panel="tab-3">Tab 3</klik-tab>
  <klik-tab slot="nav" panel="tab-4">Tab 4</klik-tab>
  <klik-tab slot="nav" panel="tab-5">Tab 5</klik-tab>
  <klik-tab slot="nav" panel="tab-6">Tab 6</klik-tab>
  <klik-tab slot="nav" panel="tab-7">Tab 7</klik-tab>
  <klik-tab slot="nav" panel="tab-8">Tab 8</klik-tab>
  <klik-tab slot="nav" panel="tab-9">Tab 9</klik-tab>
  <klik-tab slot="nav" panel="tab-10">Tab 10</klik-tab>
  <klik-tab slot="nav" panel="tab-11">Tab 11</klik-tab>
  <klik-tab slot="nav" panel="tab-12">Tab 12</klik-tab>
  <klik-tab slot="nav" panel="tab-13">Tab 13</klik-tab>
  <klik-tab slot="nav" panel="tab-14">Tab 14</klik-tab>
  <klik-tab slot="nav" panel="tab-15">Tab 15</klik-tab>
  <klik-tab slot="nav" panel="tab-16">Tab 16</klik-tab>
  <klik-tab slot="nav" panel="tab-17">Tab 17</klik-tab>
  <klik-tab slot="nav" panel="tab-18">Tab 18</klik-tab>
  <klik-tab slot="nav" panel="tab-19">Tab 19</klik-tab>
  <klik-tab slot="nav" panel="tab-20">Tab 20</klik-tab>

  <klik-tab-panel name="tab-1">Tab panel 1</klik-tab-panel>
  <klik-tab-panel name="tab-2">Tab panel 2</klik-tab-panel>
  <klik-tab-panel name="tab-3">Tab panel 3</klik-tab-panel>
  <klik-tab-panel name="tab-4">Tab panel 4</klik-tab-panel>
  <klik-tab-panel name="tab-5">Tab panel 5</klik-tab-panel>
  <klik-tab-panel name="tab-6">Tab panel 6</klik-tab-panel>
  <klik-tab-panel name="tab-7">Tab panel 7</klik-tab-panel>
  <klik-tab-panel name="tab-8">Tab panel 8</klik-tab-panel>
  <klik-tab-panel name="tab-9">Tab panel 9</klik-tab-panel>
  <klik-tab-panel name="tab-10">Tab panel 10</klik-tab-panel>
  <klik-tab-panel name="tab-11">Tab panel 11</klik-tab-panel>
  <klik-tab-panel name="tab-12">Tab panel 12</klik-tab-panel>
  <klik-tab-panel name="tab-13">Tab panel 13</klik-tab-panel>
  <klik-tab-panel name="tab-14">Tab panel 14</klik-tab-panel>
  <klik-tab-panel name="tab-15">Tab panel 15</klik-tab-panel>
  <klik-tab-panel name="tab-16">Tab panel 16</klik-tab-panel>
  <klik-tab-panel name="tab-17">Tab panel 17</klik-tab-panel>
  <klik-tab-panel name="tab-18">Tab panel 18</klik-tab-panel>
  <klik-tab-panel name="tab-19">Tab panel 19</klik-tab-panel>
  <klik-tab-panel name="tab-20">Tab panel 20</klik-tab-panel>
</klik-tab-group>
```
...
```html preview
<klik-tab-group activation="manual">
  <klik-tab slot="nav" panel="general">General</klik-tab>
  <klik-tab slot="nav" panel="custom">Custom</klik-tab>
  <klik-tab slot="nav" panel="advanced">Advanced</klik-tab>
  <klik-tab slot="nav" panel="disabled" disabled>Disabled</klik-tab>
...
[component-metadata:klik-tab-group]
